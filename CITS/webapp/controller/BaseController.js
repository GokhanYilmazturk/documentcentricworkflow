sap.ui.define([
    ...
    "use strict";
    return Controller.extend("com.sap.bpm.CITS.BaseController", {
        ...
        fnInitializeApp: function () {
            ...
            var sRootPath = jQuery.sap.getModulePath("com.sap.bpm.CITS");
            oMdlCommon.attachRequestCompleted(function (oEvent) {

                var requestId = Math.floor(Date.now() / 1000);
                oMdlCommon.setProperty("/sRequestId", requestId);
                oMdlCommon.refresh();
            });
