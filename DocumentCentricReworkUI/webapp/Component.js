sap.ui.define([
    ...
    return UIComponent.extend("com.sap.bpm.DocumentCentricReworkUI.Component", {
        ...
        init: function () {
            ...
            var contextModel = new JSONModel("/comsapbpmDocumentCentricReworkUI/workflowruntime/v1/task-instances/" + taskId + "/context");
            ...
            var taskInstanceModel = new JSONModel("/comsapbpmDocumentCentricReworkUI/workflowruntime/v1/task-instances/" + taskId);
