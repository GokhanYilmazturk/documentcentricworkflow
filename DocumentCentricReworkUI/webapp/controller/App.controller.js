    ...
    return BaseController.extend("com.sap.bpm.DocumentCentricReworkUI.controller.App", {
        ...
        _triggerComplete: function (processContext, taskId, approvalStatus) {
            ...
            $.ajax({
                ...
                url: "/comsapbpmDocumentCentricReworkUI/workflowruntime/v1/xsrf-token",
                method: "GET",
                headers: {
                    "X-CSRF-Token": "Fetch"
                },
                success: function (result, xhr, data) {
                    ...
                    $.ajax({
                        ...
                        url: "/comsapbpmDocumentCentricReworkUI/workflowruntime/v1/task-instances/" + taskId,
                        method: "PATCH",
        ...
        */
        loadAttachments: function () {
            ...
            var sAttachmentsUploadURL = "/comsapbpmDocumentCentricReworkUI/docservice/WorkflowManagement/DocumentCentricApprovalProcess/"
                + workflowInstanceId + "/";
